...
class Perfil : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        inputUsuario = findViewById(R.id.inputUsuarioPerfil)
        inputNombre = findViewById(R.id.inputNombrePerfil)
        inputApellidos = findViewById(R.id.inputApellidosPerfil)
        inputEmail = findViewById(R.id.inputEmailPerfil)
        inputFecha = findViewById(R.id.inputFechaPerfil)
